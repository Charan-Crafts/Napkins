        ...
        >
          <div className="card-body p-4">
            ...
            <form onSubmit={handleLogin} autoComplete="off">
              <div className="mb-3">
                ...
                <input
                  type="email"
                  name="email"
                  className="form-control form-control-lg shadow-sm input-animated"
                  style={{
              ...
              <button
                className="btn w-100 mt-2 py-2 fs-5 fw-bold d-flex align-items-center justify-content-center btn-animated"
                style={{
            ...
            <p className="text-center mt-4 mb-0">
              <span style={{ color: "#ff003c", fontWeight: 500 }}>Don't have an account?</span>{" "}
              <Link to="/signup" style={{ color: "#fff", fontWeight: 600, textShadow: "0 2px 8px #ff003c55" }}>
                Sign up here
              </Link>
            </p>
